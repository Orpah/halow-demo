...
(function (global) {
  ...
  var D = {
    zh: {
      ...
      "tk_real_caveat": "当前演示只有 1 台 Router 且上报里 router_id 为空 → 单测点只能得到「距离」，不足以定位到点；多路由器（各自带 router_id + 已知坐标）上报后才可三边定位。",
    ...
    en: {
      ...
      "tk_real_caveat": "This demo has only 1 router and reports carry an empty router_id \u2192 a single anchor yields distance only, not a position; trilateration needs multiple routers (each with router_id + known coords).",
