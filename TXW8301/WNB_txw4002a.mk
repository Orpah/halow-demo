...
CHECKSUM               :=$(CDKPath)/CSKY/FlashProgrammer/Bins/crc32.exe
...
$(IntermediateDirectory)/common_tcptest$(ObjectSuffix): ../sdk/lib/common/tcptest.c  
	$(CC) $(SourceSwitch) ../sdk/lib/common/tcptest.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/common_tcptest$(ObjectSuffix) -MF$(IntermediateDirectory)/common_tcptest$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/common_tcptest$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/common_tcptest$(PreprocessSuffix): ../sdk/lib/common/tcptest.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/common_tcptest$(PreprocessSuffix) ../sdk/lib/common/tcptest.c
...
$(IntermediateDirectory)/macbus_gmac_bus$(ObjectSuffix): ../sdk/lib/bus/macbus/gmac_bus.c  
	$(CC) $(SourceSwitch) ../sdk/lib/bus/macbus/gmac_bus.c $(CFLAGS) -MMD -MP -MT$(IntermediateDirectory)/macbus_gmac_bus$(ObjectSuffix) -MF$(IntermediateDirectory)/macbus_gmac_bus$(DependSuffix) $(ObjectSwitch)$(IntermediateDirectory)/macbus_gmac_bus$(ObjectSuffix) $(IncludeCPath) $(IncludePackagePath)
Lst/macbus_gmac_bus$(PreprocessSuffix): ../sdk/lib/bus/macbus/gmac_bus.c
	$(CC) $(CFLAGS)$(IncludeCPath) $(PreprocessOnlySwitch) $(OutputSwitch) Lst/macbus_gmac_bus$(PreprocessSuffix) ../sdk/lib/bus/macbus/gmac_bus.c
